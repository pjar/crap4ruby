...
class PrismNodeClassificationTest < Minitest::Test
  ...
  FREE = %i[
    ...
    BreakNode CallOperatorWriteNode CallTargetNode CapturePatternNode
  ...
  def test_every_prism_node_type_is_classified
    ...
    classified = COUNTED + SPECIAL + BOUNDARY + FREE
  ...
  def test_partitions_do_not_overlap
    partitions = { counted: COUNTED, special: SPECIAL, boundary: BOUNDARY, free: FREE }
